...
* AI
** Githubs Copilot Chat
[[https://github.com/chep/copilot-chat.el][Plugin Page]]
...
#+end_src
** TODO Githubs Copilot Completion
[[https://github.com/copilot-emacs/copilot.el][Plugin Page]]
#+begin_src emacs-lisp :tangle no
(package! copilot
...
** TODO ORG-AI Assistance
[[https://github.com/rksm/org-ai?tab=readme-ov-file#installation][Org AI]]
#+begin_src emacs-lisp :tangle no
(package! org-ai :recipe (:host github :repo "rksm/org-ai"))
#+end_src

** TODO GPtel Chat Client for GPT
[[https://github.com/karthink/gptel][Plugin Page]]
[[https://www.blogbyben.com/2024/08/gptel-mindblowing-integration-between.html][Mindblowing integration between Emacs and ChatGPT]]
#+begin_src emacs-lisp :tangle no
