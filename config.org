...
#+begin_src emacs-lisp
(map!
 "C-c t m" #'global-hide-mode-line-mode
 "C-c t M" #'hide-mode-line-mode
 "C-c f i" #'pwd
 )
#+end_src

When centaur tabs used, the file name is not needed at modeline.
#+begin_src emacs-lisp :tangle no
(after! doom-modeline
  (setq doom-modeline-buffer-name nil) ;; Whether display the buffer name.
  ;;(setq doom-modeline-major-mode-icon t) ;; Whether display the icon for `major-mode'. It respects option `doom-modeline-icon'.
  )
#+end_src
* Fonts
;; "JetBrains Mono"
