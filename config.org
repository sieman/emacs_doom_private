...
(after! dirvish
  (setq! dirvish-quick-access-entries
         `(
           ("b" "~/Documents/Bewerbung/2026" "Bewerbung")
...
(map!
 ...
 (:when (fboundp 'avy-goto-char-2 ) "s-B" #'casual-avy-tmenu)
...
#+begin_src emacs-lisp :tangle +controlkeys.el
(map!
 (:prefix "C-c w"
  :desc "Select frame by number" "w" #'ace-select-window  ))
#+end_src
