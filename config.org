...
(map!  "s-d" #'sim/duplicate-line-or-region)
#+end_src
...
| ü      | -                       |                              |            |         |
| ö      | -                       |                              |            |         |
| ä      | [[elisp:(helpful-command 'avy-goto-char-2)][avy-goto-char-2]]         |                              | s-ä        |         |
| p      | [[elisp:(helpful-command 'ns-print-buffer)][ns-print-buffer]]         |                              | s-p        |         |
...
(map!
 ...
 "s-ß" #'hippie-expand
 "s-ẞ" #'+company/complete
 "s-ſ" #'completion-at-point
 "s-ς" #'completion-help-at-point
 )
#+end_src
