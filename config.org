  ...
  (defun doom-modeline--neo2-fly-keys ()
    ...
    (when (bound-and-true-p xah-fly-keys)
      (if xah-fly-insert-state-q
        ...
        (doom-modeline--modal-icon "Commant"
...
(doom-modeline-def-modeline 'main
  ...
  '(objed-state misc-info persp-name battery grip irc mu4e gnus github debug repl lsp minor-modes input-method indent-info buffer-encoding major-mode process vcs checker modals "  "))
  (custom-set-faces!
  '(mode-line :height 0.94)
  '(mode-line-inactive :height 0.94))
...
*** Mixed Font pitch
[[https://www.dschapman.com/notes/33f4867d-dbe9-4c4d-8b0a-d28ad6376128][Mix Monospace and Variable Fonts in Doom Emacs]]
