...
(package! peep-dired)
;; (package! doom-nano-modeline :recipe (:host github :repo "ronisbr/doom-nano-modeline")) ; does not realy good work
#+end_src
           ...
           (after! flycheck
             (set-face-attribute 'flycheck-error nil
                                 :underline `(:color ,(doom-color 'functions)
                                              :style wave))))
;; (use-package! doom-nano-modeline  ;; nano modeline does not realy work
;;   :config
...
(after! org
  ...
  (add-to-list 'org-structure-template-alist '("sa" . "src emacs-lisp :tangle autoload.el"))
